...
func init() {
	...
	orm.RegisterDataBase("default", "mysql", "root:123456@tcp(127.0.0.1:3306)/freecake?charset=utf8", 30)
...
// create database if not exists freecake default charset utf8 collate utf8_general_ci;
// 自动拼装一个视图 desc facility_houses;